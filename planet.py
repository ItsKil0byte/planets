...
class Planet:
    ...
    # AU - астрономическая единица. Расстояние от Земли до Солнца.
    AU = 149.6e6 * 1000
    # G - гравитационная постоянная. Определяет силу гравитации между двумя объектами.
    G = 6.67428e-11
    # Масштаб для визуализации. 1 AU = 100 пикселей.
    SCALE = 250 / AU
    # Шаг времени для симуляции. 1 шаг = 1 день.
    TIMESTEP = 3600 * 24
